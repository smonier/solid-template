            ...
            <div className="pricing-table-inner is-revealing">
                <div className="pricing-table-main">
                    <div className="pricing-table-header pb-24">
                        <div className="pricing-table-price"><span
                            ...
                            className="pricing-table-price-amount h1">{props.price}</span></div>
                    </div>
                ...
                <div className="pricing-table-cta mb-8">
                    <a className="button button-primary button-shadow button-block"
                       href={props.pricingButtonLink ? jUrl({path: props.pricingButtonLink.getPath()}) : '#'}>{props.pricingButtonText}</a>
                </div>
            </div>
        </div>
    )
